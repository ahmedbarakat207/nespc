...
public:
    ...
    // Public interface for bus
    void cpuWrite(uint16_t addr, uint8_t data);
    uint8_t cpuRead(uint16_t addr);
    void clock();
    
    // Public members for main loop
    bool nmi = false;
    ...
    // OAM - made public for bus access
...
private:
    // PPU memory - ensure proper initialization order
    std::shared_ptr<rom> cartridge = nullptr; // Initialize FIRST
